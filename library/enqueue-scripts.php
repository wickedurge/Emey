...
if ( ! function_exists( 'foundationpress_scripts' ) ) :
	...
	wp_enqueue_style( 'custom-stylesheet', get_stylesheet_directory_uri() . '/css/emey.css' );

	// Enqueue Google Fonts.
	wp_register_style ( 'GoogleFonts','http://fonts.googleapis.com/css?family=VT323|Roboto|Roboto+Slab');
	...
	// Add in the typed.js for the homepage.
	wp_enqueue_script( 'typed', get_template_directory_uri() . '/js/custom/typed.js/js/typed.js');
